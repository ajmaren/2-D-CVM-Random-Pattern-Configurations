...
def plotAndPrintPerturbationResults (x1TargetVal, hArray, hTotalSteps, hStep, totalChangesPerturbationsArray, totalChangesEquilibriumArray):  
    ...
    for k in range (0, hTotalSteps, hStep):
        print '   %.2f' % (hArray[k]), '          ', totalChangesPerturbationsArray[k], '          ', totalChangesEquilibriumArray[k] 
        

                                                                      
    pylab.figure(1)
    pylab.plot (hArray, totalChangesPerturbationsArray)          
    pylab.plot (hArray, totalChangesEquilibriumArray, 'g')
...
#        if not debugPrintOff:
        ...
        for hVal in range (0, hTotalSteps, hStep):
            ...
            totalChangesPerturbationsArray[hVal] = countTotalChangesInUnitArray (arraySizeList, startingPerturbedArray, perturbedEqlbrmUnitArray)               

            totalChangesEquilibriumArray[hVal] = countTotalChangesInUnitArray (arraySizeList, unitArray, perturbedEqlbrmUnitArray)               
            
    print ' ' 
    print ' Perturbation Results Summary'
    plotAndPrintPerturbationResults (x1TargetVal, hArray, hTotalSteps, hStep, totalChangesPerturbationsArray, totalChangesEquilibriumArray)                                               
    print ' '                                                                                                                     
